...
class _AuthorizeSettingPageState extends State<AuthorizeSettingPage>
  ...
  List<_AuthorizeSettingSection> _buildSections() {
    final notificationSection = _AuthorizeSettingSection(
    ...
    if (_isIOS) {
      return [
        ...
        _AuthorizeSettingSection(
          ...
          subtitle: _localeText(
            zh: '这些授权影响语音、提醒、文件导入导出和系统集成。',
            en: 'These permissions affect voice, reminders, file access, and system integration.',
          ),
          items: [
            _AuthorizeSettingItem(
              icon: Icons.notifications_active_outlined,
              title: _localeText(zh: '通知权限', en: 'Notifications'),
              subtitle: _localeText(
                zh: '用于任务提醒、运行反馈和恢复提示。',
                en: 'Used for task reminders, run feedback, and recovery prompts.',
              ),
              ...
              onTap: _openIosSystemSettings,
            ),
            _AuthorizeSettingItem(
              icon: Icons.mic_none_rounded,
              title: _localeText(zh: '麦克风权限', en: 'Microphone'),
              subtitle: _localeText(
                zh: '用于语音输入、录音和实时对话。',
                en: 'Used for voice input, recording, and live conversations.',
              ),
              trailing: _buildPermissionTrailing(
            ...
            _AuthorizeSettingItem(
              ...
              title: _localeText(zh: '文件访问', en: 'File Access'),
              subtitle: _localeText(
                zh: '用于导入导出工作区、模型和附件。',
                en: 'Used to import and export workspaces, models, and attachments.',
              ),
              trailing: _buildPermissionTrailing(
            ...
            _AuthorizeSettingItem(
              ...
              title: _localeText(zh: '语音识别权限', en: 'Speech Recognition'),
              subtitle: _localeText(
                zh: '用于语音转写和语音命令理解。',
                en: 'Used for transcription and voice command understanding.',
              ),
              trailing: _buildPermissionTrailing(
                label: context.trLegacy(
        ...
        _AuthorizeSettingSection(
          label: _localeText(zh: '系统设置', en: 'System Settings'),
          subtitle: _localeText(
            zh: '在 iOS 设置中管理通知、麦克风、语音识别与文件访问。',
            en: 'Manage notifications, microphone, speech, and file access in iOS Settings.',
          ),
          items: [
            _AuthorizeSettingItem(
              icon: Icons.settings_outlined,
              title: _localeText(zh: '打开系统设置', en: 'Open System Settings'),
              subtitle: _localeText(
                zh: '跳转到 Omnibot 的系统授权页面。',
                en: 'Open Omnibot system authorization settings.',
              ),
              trailing: Icon(
    ...
    try {
      if (_isIOS) {
        ...
        setState(() {
          ...
          _accessibilityPermission =
              snapshot?.speechRecognitionGranted ?? false;
        });
        return;
      }
