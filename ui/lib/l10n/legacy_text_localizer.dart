...
class LegacyTextLocalizer {
  ...
  static final Map<String, String> _exactEn = <String, String>{
    ...
    '无法打开 Agent 管理面板': 'Unable to open Agent manager',
    '关闭悬浮球失败': 'Failed to hide floating capsule',
    '悬浮球已关闭，可在设置里重新开启':
        'Floating capsule hidden. You can re-enable it in Settings.',
    '点开': 'Open',
    '隐藏悬浮球': 'Hide floating capsule',
    '收起': 'Collapse',
    '停止失败': 'Failed to stop',
    '运行中的 Agent': 'Running Agents',
    '当前没有后端任务': 'No backend tasks running',
    '当前没有任何 Agent': 'No Agents running',
    '停止全部': 'Stop all',
    '没有正在执行的 Agent 后端任务': 'No running Agent backend tasks',
    '打开': 'Open',
    '停止这个 Agent': 'Stop this Agent',
    'Agent 后端空闲。轻点打开管理面板。': 'Agent backend idle. Tap to open manager.',
    '正在整理方案': 'Organizing plan',
    '正在输出': 'Writing response',
    '开始调用工具': 'Starting tool call',
    '工具执行中': 'Tool running',
    '工具完成': 'Tool completed',
    '等待权限确认': 'Waiting for permission',
    '等待补充信息': 'Waiting for more information',
    '运行出错': 'Run failed',
    '即将完成': 'Finishing',
    'Agent 后端任务': 'Agent backend task',
