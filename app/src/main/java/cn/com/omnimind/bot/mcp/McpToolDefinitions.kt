...
""".trimIndent(),
        "inputSchema" to mapOf(
            ...
            "properties" to mapOf(
                ...
                "htmlFiles" to mapOf("type" to "array", "description" to "Optional HTML/CSS/JS files under frontend/html/. Include index.html for html_webview Displays. Default to a phone portrait Workspace WebView layout: viewport width=device-width, one column, compact first viewport, about 360-430dp wide and 640-820dp tall after app chrome. Portrait reports should use a phone-width article layout with the executive summary in the first 640-720dp; use viewport width=1280 only for explicit wide reports or slide decks."),
