...
""".trimIndent(),
        "inputSchema" to mapOf(
            ...
            "properties" to mapOf(
                ...
                "htmlFiles" to mapOf("type" to "array", "description" to "Optional HTML/CSS/JS files under frontend/html/. Include index.html for html_webview Displays. Default to the app-injected Workbench Display layout profile: viewport width=device-width, one column, compact first viewport, targeting the measured viewportWidthDp/viewportHeightDp instead of hard-coded phone dimensions. Portrait reports should use a phone-width article layout with the executive summary in the first measured viewport; use viewport width=1280 only for explicit wide reports or slide decks."),
