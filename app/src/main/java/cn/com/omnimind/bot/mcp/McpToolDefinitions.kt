...
""".trimIndent(),
        "inputSchema" to mapOf(
            ...
            "properties" to mapOf(
                ...
                "htmlFiles" to mapOf("type" to "array", "description" to "Optional HTML/CSS/JS files under frontend/html/. Include index.html for html_webview Displays. Default to a phone portrait Workspace WebView layout: viewport width=device-width, one column, compact first viewport, about 360-430dp wide. Portrait reports should use a phone-width article layout; use viewport width=1280 only for explicit wide reports or slide decks."),
